        ...
        <div className="border-b border-border p-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Dialog open={uploadDialogOpen} onOpenChange={setUploadDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>Upload PDF Documents {demoMode && "(Demo Mode)"}</DialogTitle>
                </DialogHeader>
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <p className="text-sm text-muted-foreground mb-2">Click to select PDF files or drag and drop</p>
                    <p className="text-xs text-muted-foreground">
                      {demoMode ? "Demo mode - files will be simulated" : "Only PDF files are supported"}
                    </p>
                  </div>
                  <input
                    ref={fileInputRef}
                  ...
                  {uploading && (
                    <div className="text-center">
                      <div className="text-sm text-muted-foreground">
                        {demoMode ? "Simulating upload..." : "Uploading and processing documents..."}
                      </div>
                    </div>
                  )}
                </div>
