...
export default function ChatInterface() {
  ...
  setUploadAlert && setUploadAlert(`✅ Successfully processed ${result.files_processed?.length ?? 0} file${(result.files_processed?.length ?? 0) !== 1 ? "s" : ""}.`)
  setTimeout(() => setUploadAlert && setUploadAlert(null), 6000)
    } catch (error) {
